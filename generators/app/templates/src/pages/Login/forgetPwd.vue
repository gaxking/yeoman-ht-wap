...
<template>
  <div>
    <div class="loginForm">
      ...
      <group v-if="step==2">
        <x-input type="password" :max="16" placeholder="请输入新密码" @on-change="change" v-model="pwd.pwd1"></x-input>
        <x-input type="password" :max="16" placeholder="请再次输入新密码" @on-change="change" v-model="pwd.pwd2"></x-input>
      </group>
    </div>
    <div class="m_15">
